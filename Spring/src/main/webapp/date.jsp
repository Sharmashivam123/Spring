...
<body>
	...
	<div class="container-fluid text-center pt-5" id="book">
		<div class="display-4 d-block mt-4" id="header">Select the date
			on you want to book</div>
		<div id="registeration">
			<form action="timings" method="get" class="w-50 mx-auto">
				<select name="date" class="form-control mt-4">
