...
CREATE TABLE `bookings` (
  ...
  CONSTRAINT `bookings_ibfk_5` FOREIGN KEY (`seatId`) REFERENCES `seatarrangements` (`seatId`),
  CONSTRAINT `bookings_ibfk_6` FOREIGN KEY (`seatId`) REFERENCES `seatarrangements` (`seatId`)
...
-- Dump completed on 2019-11-07  9:51:03
