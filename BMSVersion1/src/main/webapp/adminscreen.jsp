		...
		<div id="registeration" class="table w-100 p-4">
			<table name="screen" class="bg-light mt-4 mx-auto"
				...
				<c:forEach var="seat" items="${seats}">
					<tr>
						<form action="/adminupdtscreen" method="get" class="w-50 mx-auto">
						...
						<form action="/admindltscreen" method="get" class="w-50 mx-auto">
				...
				<tr>
					<form action="/adminaddscreen" method="get" class="w-50 mx-auto">
